...
md"""
**2.** Let us generalize this result to infinite dimensional spaces (this will be useful for later parts of the course). Consider a sequence of positive weights $\omega_k$, $k \in \mathbb{N}$, and the sequence space
